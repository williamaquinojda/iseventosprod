<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            @if (!empty($place->id))
                <x-forms.buttons.primary route="places.rooms.index" :id="$place->id" label="Salas" />
                <x-forms.buttons.primary route="places.documents.index" :id="$place->id" label="Documentos" />
            @endif
        </div>
