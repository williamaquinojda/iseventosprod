<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('places.rooms.index', [$room->place_id, $room->id]) }}"
        ...
        <div class="intro-y col-span-12">
            @if (empty($document->id))
                {!! Form::open([
                    'route' => ['places.rooms.documents.store', [$room->place_id, $room->id]],
                    'method' => 'post',
            ...
            @else
                {!! Form::model($document, [
                    'route' => ['places.rooms.documents.update', [$room->place_id, $room->id, $document->id]],
                    'method' => 'put',
                    'class' => 'needs-validation',
                    'files' => 'true',
                ]) !!}
