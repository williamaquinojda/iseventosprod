    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <form action="{{ route('products.index') }}" method="GET" class="flex">
                ...
                <a href="{{ route('products.index') }}" class="btn btn-secondary shadow-md ml-2">Limpar</a>
            </form>
            <div class="hidden md:block mx-auto text-slate-500"></div>
            <x-forms.buttons.create route="products.create" />
        </div>
        <!-- BEGIN: Data List -->
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <x-forms.buttons.edit route="products.edit" :id="$product->id" />
                                    <x-forms.buttons.destroy route="products.destroy" :id="$product->id" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
