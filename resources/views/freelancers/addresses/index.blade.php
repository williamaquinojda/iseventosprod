<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <x-forms.buttons.create route="freelancers.addresses.create" :id="$freelancer->id" />
        </div>
        <!-- BEGIN: Data List -->
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @foreach ($addresses as $address)
                        <tr class="intro-x">
                            <td>
                                <a href="{{ route('freelancers.addresses.show', [$freelancer->id, $address->id]) }}"
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <x-forms.buttons.edit route="freelancers.addresses.edit" :id="[$freelancer->id, $address->id]" />
                                    <x-forms.buttons.destroy route="freelancers.addresses.destroy" :id="[$freelancer->id, $address->id]" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
