<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <x-forms.buttons.create route="customers.addresses.create" :id="$customer->id" />
        </div>
        <!-- BEGIN: Data List -->
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <x-forms.buttons.edit route="customers.addresses.edit" :id="[$customer->id, $address->id]" />
                                    <x-forms.buttons.destroy route="customers.addresses.destroy" :id="[$customer->id, $address->id]" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
